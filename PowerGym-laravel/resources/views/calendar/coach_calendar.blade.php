...
@section('title', 'Power Gym - Coach Calendar')
...
<div class="calendar-section">
    ...
    <p>View the schedule of events for the selected coach. The calendar below showcases all the upcoming events for this coach.</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: @json($formattedCoachEvents),
